...
export default function Header() {
  ...
  return (
    <header className="fixed inset-x-0 top-4 z-[100] flex flex-col items-center gap-2.5 px-2 sm:px-4 pointer-events-none">
      <div className="pointer-events-auto relative flex w-full max-w-[99%] items-center justify-between gap-2 rounded-full border border-white/40 bg-white/80 px-5 sm:px-8 py-2.5 shadow-[0_8px_32px_rgba(0,0,0,0.1)] backdrop-blur-2xl transition-all hover:bg-white/90 ring-1 ring-white/20">
        ...
        <div className="flex items-center gap-2 xl:flex-1">
          <a
            ...
            target="_blank"
            className="xl:hidden flex h-9 w-9 items-center justify-center rounded-full bg-gradient-to-br from-green-500 to-emerald-600 text-white shadow-lg shadow-green-500/20 transition-all hover:scale-110 active:scale-95"
          >
            <FaWhatsapp size={18} />
          </a>
          <Link href="/" className="hidden xl:flex items-center shrink-0 transition-transform hover:opacity-80">
            <span className="font-[family-name:var(--font-poppins)] text-2xl sm:text-[1.35rem] md:text-2xl tracking-tight flex items-center whitespace-nowrap">
              <span className="font-bold text-[#0F1C4A]">BEYOND</span>
              <span className="font-light text-[#0F1C4A] ml-1.5">REACH</span>
            </span>
          </Link>
        </div>
        ...
        <div className="absolute left-1/2 top-1/2 -translate-x-1/2 -translate-y-1/2 xl:static xl:translate-x-0 xl:translate-y-0">
          <Link href="/" className="xl:hidden flex items-center shrink-0 transition-transform hover:opacity-80">
            <span className="font-[family-name:var(--font-poppins)] text-2xl sm:text-[1.35rem] md:text-2xl tracking-tight flex items-center whitespace-nowrap">
              <span className="font-bold text-[#0F1C4A]">BEYOND</span>
              <span className="font-light text-[#0F1C4A] ml-1.5">REACH</span>
            </span>
        ...
        {/* RIGHT SECTION */}
        <div className="flex items-center justify-end gap-2 xl:flex-1">
          ...
          <Link 
            href="/contact" 
            className={`hidden xl:block rounded-full px-3 py-1.5 text-[10px] font-black transition-all tracking-[0.15em] uppercase ${
          ...
          <button
            ...
            className="xl:hidden flex h-10 w-10 items-center justify-center rounded-full bg-white text-slate-900 border border-slate-100 shadow-sm active:scale-90 transition-transform"
          >
