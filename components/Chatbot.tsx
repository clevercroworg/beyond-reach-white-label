...
const matchInputToNavigation = (text: string) => {
  ...
  if (t.includes("about") || t.includes("beyond reach")) {
...
export default function Chatbot() {
  ...
  const [messages, setMessages] = useState<Message[]>([
    {
      id: "1",
      sender: "bot",
      text: "Hi! Welcome to BEYOND REACH. 😊 I can help you explore our services, get a quick project estimate, or put you in touch with our team.\n\nWhat can we build or grow for you today? 🐦",
      options: [
        "🌐 Website Development",
        "📱 App Development",
        "🤖 AI & Automation",
  ...
  const handleGreeting = (text: string, state: ChatbotState, messagesBefore: Message[]) => {
    ...
    let prefix = "Hello there! 😊 Hope you're having a wonderful day. I'm the BEYOND REACH digital assistant.\n\n";

    if (isHowAreYou) {
      prefix = "I'm doing great, thanks for asking! 😊 Ready to help you build or scale your business.\n\n";
    } else if (isWhoAreYou) {
      prefix = "I'm the BEYOND REACH assistant! 🐦 We help businesses design custom websites, build web/mobile apps, automate workflows (like WhatsApp/AI bots), and run Google/Meta ads.\n\n";
  ...
  const processInput = async (
    ...
    switch (prevState.stage) {
      ...
      case "completed": {
        ...
        addMessage({
          sender: "bot",
          text: "Hi! I'm the BEYOND REACH AI. 🐦\n\nWhat can we build or grow for you today?",
          options: getOptionsForState(startState)
        });
        break;
      }
          ...
          >
            ...
            <div className="relative p-4 flex justify-between items-center bg-slate-50/60 backdrop-blur-md border-b border-slate-200/60 z-10">
              <div className="flex items-center gap-3">
                ...
                <div>
                  <h3 className="font-bold text-sm text-slate-800 tracking-tight leading-none mb-1">BEYOND REACH AI</h3>
