    ...
    <header id="site-header" className={`fixed inset-x-0 top-3 z-50 transition-all duration-300 ${isHeaderScrolled ? "header-scrolled" : ""}`}>
      <div className="mx-auto flex max-w-7xl items-center justify-between px-4 py-3 sm:px-6 lg:px-8">
        <a href="#top" className="flex items-center gap-3">
          <div className="flex items-center text-xl sm:text-2xl tracking-tight text-slate-900">
        ...
        <div className="flex items-center gap-2 sm:gap-3">
          <a
            ...
            className="inline-flex h-[38px] w-[38px] sm:h-11 sm:w-11 items-center justify-center rounded-full bg-[#f4c542] text-black transition hover:brightness-110 shadow-sm border border-transparent"
            aria-label="Call Us"
          >
          ...
          <a
            ...
            target="_blank"
            rel="noreferrer"
            className="inline-flex h-[38px] w-[38px] sm:h-11 sm:w-11 items-center justify-center rounded-full bg-green-500 text-white transition hover:bg-green-600 shadow-sm"
