...
const googleAdsReviews = [
  {
    ...
    text: "We partnered with BEYOND REACH to improve our digital presence and lead generation. Their understanding of SEO, Google Ads, and automation is extremely practical. Within a few months, we saw consistent inbound leads.",
    rating: 5,
  },
  {
    name: "KIFSE",
    text: "BEYOND REACH helped us restructure our paid ads and website funnels. What stood out was their data-driven approach and clear communication. The transition was seamless and results were immediate.",
    rating: 5,
  },
  {
    name: "Malpe Boating",
    text: "The BEYOND REACH team understood our business goals clearly and implemented solutions that genuinely saved us time and increased our ROI. Highly recommended for any growing brand.",
    rating: 5,
  },
  {
    name: "Bethany",
    text: "BEYOND REACH stands out for their honesty and execution. Everything was delivered on time and with clear outcomes. They transformed our digital strategy completely.",
    rating: 5,
  },
];
